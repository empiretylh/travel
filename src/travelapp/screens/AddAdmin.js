		...
		<div className={"pages addadmin"}>
			...
			>
				<Modal.Body>
					...
					<p style={{}}>
						New Admin can control like you. This New Admin can add,
						delete and edit packages and booking.{" "}
					</p>
				</Modal.Body>
				<Modal.Footer>
					<Button
						variant={"primary"}
						onClick={(e) => setSsShow(false)}
					>
						OK
					</Button>
				</Modal.Footer>
			...
			>
				...
				<Form.Group className="mb-3" controlId="register-control">
					...
					<Form.Group className={"mb-3"}>
						...
						/>
						<Form.Text>
							Password must be contains letters and numbers
						</Form.Text>
					</Form.Group>
					<Button
						type="submit"
